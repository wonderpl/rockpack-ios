...
//
//  Adapted to Rockpack by Nick Banks

#import "TPKeyboardAvoidingScrollView.h"

#define UIKeyboardFrameEndUserInfoKey (&UIKeyboardFrameEndUserInfoKey != NULL ? UIKeyboardFrameEndUserInfoKey : @"UIKeyboardBoundsUserInfoKey")
...
- (void) setFrame: (CGRect) frame
{
    ...
    CGSize contentSize = self.originalContentSize;
...
- (void) keyboardWillShow: (NSNotification *) notification
{
    ...
    self.contentInset = [self contentInsetForKeyboard];
    [self setContentOffset: CGPointMake(self.contentOffset.x, [self idealOffsetForView: firstResponder
                                                                             withSpace: [self keyboardRect].origin.y - self.bounds.origin.y])
                  animated: YES];
