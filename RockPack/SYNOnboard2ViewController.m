...
- (void) viewDidLoad
{
    ...
    {
        self.onboardMessageLabel.font = [UIFont boldRockpackFontOfSize: 20.0];
    }
    else
    {
        self.onboardMessageLabel.font = [UIFont boldRockpackFontOfSize: 12.0];
    }
    ...
    self.onboardMessageLabel.layer.shadowRadius = 5.0f;
    
    // Opacity of onboard text shadow (0 - 1)
    self.onboardMessageLabel.layer.shadowOpacity = 0.8f;
}
