...
@interface SYNOldYouRootViewController () <UICollectionViewDataSource,
...
@implementation SYNOldYouRootViewController
                   ...
                   cellForItemAtIndexPath: (NSIndexPath *) indexPath
{
    ...
    if (!cell)
    {
        if (cv == self.channelThumbnailCollectionView)
        {
            ...
            channelCell.channelImageViewImage = channel.coverThumbnailLargeURL;
